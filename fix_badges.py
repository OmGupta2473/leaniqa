...
old_recent = "const recentBadges = useMemo(() => earnedAwards.filter(a => a.earned).slice(-6), [earnedAwards]);"
new_recent = "const recentBadges = earnedAwards.filter(a => a.earned).slice(-6);"
