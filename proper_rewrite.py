...
with open("/tmp/old_weekly.txt", "r") as f:
    content = f.read()
...
dashboard_block_old = """        {/* ── DASHBOARD VIEW ── */}
        {view === 'dashboard' && (
          <>
            {/* Ring summary card */}
            <div style={{ background: 'linear-gradient(180deg, #222224 0%, #18181A 100%)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '20px', padding: '24px', marginBottom: '14px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <div style={{ background: 'linear-gradient(180deg, #222224 0%, #18181A 100%)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '20px', padding: '18px', marginBottom: '14px' }}>
            ...
            {/* Awards row */}
            <div style={{ background: 'linear-gradient(180deg, #222224 0%, #18181A 100%)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '20px', padding: '18px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: '8px' }}>
                {recentBadges.length === 0 ? (
                  ...
                  <motion.div key={a.id} whileHover={{ y: -2 }} whileTap={{ scale: 0.96 }} style={{ aspectRatio: '1', borderRadius: '10px', border: `1.5px solid ${a.primaryColor}55`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '18px', background: `${a.primaryColor}1A`, boxShadow: `0 4px 12px ${a.primaryColor}22` }}>
                    {a.symbol}
                  </motion.div>
                ))}
              </div>
...
detail_block_old = """        {/* ── DETAIL VIEW (7-day strip) ── */}
        {view === 'detail' && (
          <>
            ...
            {last7Days.map(day => (
              <div key={day.date} style={{ background: 'linear-gradient(180deg, #222224 0%, #18181A 100%)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '16px', padding: '14px 16px', marginBottom: '10px', display: 'flex', alignItems: 'center', gap: '14px' }}>
