...
old_fetch = """            const url = new URL('/api/parse-meal', window.location.href);
...
new_fetch = """            const response = await fetch('/api/parse-meal', {
              method: 'POST',
...
if old_fetch in content:
    ...
    print("Patched fetch back to POST successfully.")
else:
