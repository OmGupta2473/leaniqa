         ...
         <div className="relative w-[50%] aspect-square flex items-center justify-center mb-[8%]">
             <svg className="absolute inset-0 w-full h-full transform -rotate-90">
               ...
               <motion.circle 
                 ...
                 animate={{ strokeDasharray: "150 1000" }}
    ...
    <div className="w-full h-full bg-[#0A0A0A] flex flex-col p-[6%]">
       ...
       <div className="flex-1 bg-white/[0.02] border border-white/5 rounded-2xl relative overflow-hidden flex flex-col justify-end p-[5%] mt-[2%]">
          ...
          <motion.div 
            ...
            style={{ width: "8%", aspectRatio: "1", right: "0%", bottom: "10%", transform: "translate(50%, 50%)" }}
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
...
function PremiumPhone({ activeStep }: { activeStep: number }) {
  ...
  return (
    ...
    >
      <PhoneFrame widthClass="w-[140px] md:w-[160px] lg:w-[220px]">
        <AnimatePresence mode="wait">
          {activeStep === 0 && (
            <PhoneScreenTransition key="chat"><AICoachScreen /></PhoneScreenTransition>
          )}
          {activeStep === 1 && (
            <PhoneScreenTransition key="dash"><DashboardScreen /></PhoneScreenTransition>
          )}
          {activeStep === 2 && (
            <PhoneScreenTransition key="timeline"><TimelineScreen /></PhoneScreenTransition>
          )}
        </AnimatePresence>
      </PhoneFrame>
    </motion.div>
...
function ScrollStory() {
  ...
  return (
    <div ref={containerRef} className="relative w-full h-[300vh]">
      <div className="sticky top-14 flex items-center justify-center overflow-hidden w-full h-[calc(100vh-3.5rem)]">
        <div className="w-full h-full max-w-7xl mx-auto px-6 lg:px-16 flex flex-col lg:flex-row items-center justify-start lg:justify-center pt-8 md:pt-12 lg:pt-0 gap-6 sm:gap-8 md:gap-10 lg:gap-20">
