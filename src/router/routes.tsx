        ...
        children: [
          {
            ...
            children: [
              ...
              { path: '/activity', element: <Suspense fallback={<WeeklyReportSkeleton />}><WeeklyReportPage /></Suspense>, handle: { title: 'Reports', description: 'Weekly compliance and activity report.' } },
